...
public final class KrakkRaySplitMath {
    ...
    public static boolean shouldSplitRay(int splitDepth, int maxSplitDepth, double energy, double minSplitEnergy,
                                         ...
                                         double baseAngularSpacing, double splitDistanceThreshold) {
        ...
        double effectiveAngularSpacing = baseAngularSpacing / Math.sqrt(1 << splitDepth);
        return radialDistance * effectiveAngularSpacing >= splitDistanceThreshold;
    }
